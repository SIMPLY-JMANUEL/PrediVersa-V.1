  ...
  return (
    <main className="page-internal-standard">
        ...
        <section className="about-section">
          ...
          <div className="about-hero" style={{ textAlign: 'center', marginBottom: '3rem' }}>
            <h1 className="responsive-title" style={{ color: '#3A6F85', marginBottom: '1rem', fontWeight: 800 }}>
              Quiénes <span className="highlight" style={{ color: '#8ECFEA' }}>Somos</span>
            </h1>
            <p style={{ fontSize: '1.2rem', color: '#555', maxWidth: '750px', margin: '0 auto', lineHeight: '1.6' }}>
              Transformamos datos en prevención. Explore los pilares de la metodología PrediVersa para el bienestar institucional.
            </p>
          </div>
            ...
            {cardsData.map((card) => (
              <div 
                ...
                style={{ 
                  ...
                  position: 'relative',
                  overflow: 'hidden',
                  maxHeight: expandedCard === card.id ? '600px' : '240px',
              ...
              >
                ...
                <div style={{ position: 'absolute', bottom: '15px', right: '25px', fontSize: '0.85rem', color: '#8ECFEA', fontWeight: 600 }}>
          ...
          <div className="value-proposition responsive-adn" style={{ padding: '3rem 2rem', borderRadius: '30px' }}>
            <div className="adn-container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem' }}>
              <div style={{ textAlign: 'left' }}>
                <h4 style={{ fontSize: '1.6rem', color: '#fff', marginBottom: '1.2rem', fontWeight: 700 }}>🎯 Nuestra Misión</h4>
              ...
              <div style={{ textAlign: 'left' }}>
                <h4 style={{ fontSize: '1.6rem', color: '#fff', marginBottom: '1.2rem', fontWeight: 700 }}>📊 Objetivos</h4>
      ...
      <footer style={{ marginTop: 'auto', padding: '2rem', color: '#94a3b8', fontSize: '0.9rem' }}>
        © {new Date().getFullYear()} PrediVersa • Inteligencia Institucional.
      </footer>
    </main>
  );
}
